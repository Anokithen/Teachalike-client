  ...
  return (
    <div className="home-night min-h-[100dvh]">
      <header className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-5 sm:px-6 sm:py-6">
        <Logo />
        <nav className="ml-auto flex w-full items-center gap-2 min-[420px]:w-auto sm:gap-3">
          {isAuthenticated ? (
            <Link href="/dashboard" className="btn-primary w-full min-[420px]:w-auto">
              Go to dashboard
            </Link>
          ) : (
            <>
              <Link href="/login" className="btn-ghost flex-1 min-[420px]:flex-none">
                Log in
              </Link>
              <Link href="/register" className="btn-primary flex-1 min-[420px]:flex-none">
                Get started
              </Link>
            </>
          )}
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6">
        <section className="grid items-center gap-8 py-10 sm:gap-10 sm:py-14 lg:grid-cols-2 lg:py-24">
          <div>
            ...
            <h1 className="text-3xl font-semibold leading-tight tracking-tight text-white min-[380px]:text-4xl sm:text-5xl">
            ...
            <div className="mt-8 flex flex-col gap-3 min-[420px]:flex-row min-[420px]:flex-wrap">
              <Link href="/register" className="btn-primary w-full min-[420px]:w-auto">
                Create your account
              </Link>
              <Link href="/login" className="btn-home-outline w-full min-[420px]:w-auto">
